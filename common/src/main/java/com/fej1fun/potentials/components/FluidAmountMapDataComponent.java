...
public class FluidAmountMapDataComponent implements Serializable {
    ...
    public FluidAmountMapDataComponent(final Map<Fluid, Long> fluidAmounts) {
        ...
        this.fluids = new ArrayList<>(fluidAmounts.keySet());
        this.amounts = new ArrayList<>(fluidAmounts.values());
    }
    ...
    public FluidAmountMapDataComponent setFluid(int i, Fluid fluid) {
        ...
        return new FluidAmountMapDataComponent(this.fluids, this.amounts);
    }
